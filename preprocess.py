...
def prepare_ISCX_2014_data(PATH="", INPUT_FILE_NAME=""):
    ...
    if network_traffic:
        data = data.drop(
            ["SrcIP", "SrcPort", "DstIP", "DstPort", "Timestamp", "Protocol"],
            axis=1,
        ).copy()
        if DEBUG:
        ...
        # =============================================================================================
        # Choose only FlowID and Label columns for labeling purposes in another data frame
        # =============================================================================================

        data_df = data[["FlowID", "Label"]].copy()
        ...
        # IRC = data_df['FlowID'].str.contains('192.168.2.112-131.202.243.84|192.168.5.122-198.164.30.2|192.168.2.110-192.168.5.122|192.168.4.118-192.168.5.122|192.168.2.113-192.168.5.122|192.168.1.103-192.168.5.122|192.168.4.120-192.168.5.122|192.168.2.112-192.168.2.110|192.168.2.112-192.168.4.120|192.168.2.112-192.168.1.103|192.168.2.112-192.168.2.113|192.168.2.112-192.168.4.118|192.168.2.112-192.168.2.109|192.168.2.112-192.168.2.105|192.168.1.105-192.168.5.122')

        IRC_1 = data_df["FlowID"].str.contains("192.168.2.112-131.202.243.84")
        IRC_2 = data_df["FlowID"].str.contains("192.168.5.122-198.164.30.2")
        IRC_3 = data_df["FlowID"].str.contains("192.168.2.110-192.168.5.122")
        IRC_4 = data_df["FlowID"].str.contains("192.168.4.118-192.168.5.122")
        IRC_5 = data_df["FlowID"].str.contains("192.168.2.113-192.168.5.122")
        IRC_6 = data_df["FlowID"].str.contains("192.168.1.103-192.168.5.122")
        IRC_7 = data_df["FlowID"].str.contains("192.168.4.120-192.168.5.122")
        IRC_8 = data_df["FlowID"].str.contains("192.168.2.112-192.168.2.110")
        IRC_9 = data_df["FlowID"].str.contains("192.168.2.112-192.168.4.120")
        IRC_10 = data_df["FlowID"].str.contains("192.168.2.112-192.168.1.103")
        IRC_11 = data_df["FlowID"].str.contains("192.168.2.112-192.168.2.113")
        IRC_12 = data_df["FlowID"].str.contains("192.168.2.112-192.168.4.118")
        IRC_13 = data_df["FlowID"].str.contains("192.168.2.112-192.168.2.109")
        IRC_14 = data_df["FlowID"].str.contains("192.168.2.112-192.168.2.105")
        IRC_15 = data_df["FlowID"].str.contains("192.168.1.105-192.168.5.122")

        Neris = data_df["FlowID"].str.contains("147.32.84.180")
        RBot = data_df["FlowID"].str.contains("147.32.84.170")
        Menti = data_df["FlowID"].str.contains("147.32.84.150")
        Sogou = data_df["FlowID"].str.contains("147.32.84.140")
        Murlo = data_df["FlowID"].str.contains("147.32.84.130")
        Virut = data_df["FlowID"].str.contains("147.32.84.160")
        Black_hole_1 = data_df["FlowID"].str.contains("10.0.2.15")
        Black_hole_2 = data_df["FlowID"].str.contains("192.168.106.141")
        Black_hole_3 = data_df["FlowID"].str.contains("192.168.106.131")
        TBot_1 = data_df["FlowID"].str.contains("172.16.253.130")
        TBot_2 = data_df["FlowID"].str.contains("172.16.253.131")
        TBot_3 = data_df["FlowID"].str.contains("172.16.253.129")
        TBot_4 = data_df["FlowID"].str.contains("172.16.253.240")
        Weasel_master = data_df["FlowID"].str.contains("74.78.117.238")
        Weasel_bot = data_df["FlowID"].str.contains("158.65.110.24")
        Zeus_1 = data_df["FlowID"].str.contains("192.168.3.35")
        Zeus_2 = data_df["FlowID"].str.contains("192.168.3.25")
        Zeus_3 = data_df["FlowID"].str.contains("192.168.3.65")
        bin_Zeus = data_df["FlowID"].str.contains("172.29.0.116")
        Osx_trojan = data_df["FlowID"].str.contains("172.29.0.109")
        Zero_access_1 = data_df["FlowID"].str.contains("172.16.253.132")
        Zero_access_2 = data_df["FlowID"].str.contains("192.168.248.165")
        Smoke_bot = data_df["FlowID"].str.contains("10.37.130.4")
        if CTU_NERIS:

            CTU_neris = data_df["FlowID"].str.contains("147.32.84.165")

        # SARUMAN1 = data_df['FlowID'].str.contains('147.32.84.191')
        # SARUMAN2 = data_df['FlowID'].str.contains('147.32.84.192')
        # SARUMAN3 = data_df['FlowID'].str.contains('147.32.84.193')

        # SARUMAN4 = data_df['FlowID'].str.contains('147.32.84.204')
        # SARUMAN5 = data_df['FlowID'].str.contains('147.32.84.205')
        # SARUMAN6 = data_df['FlowID'].str.contains('147.32.84.206')
        # SARUMAN7 = data_df['FlowID'].str.contains('147.32.84.207')
        # SARUMAN8 = data_df['FlowID'].str.contains('147.32.84.208')
        # SARUMAN9 = data_df['FlowID'].str.contains('147.32.84.209')
    ...
    data_df = data.drop(["FlowID", "Label"], axis=1)
    ...
    # =============================================================================================
    data = data.drop(["FlowID"], axis=1)

    data = round(data, 8).copy()

    if DEBUG:
        print(" Data Columns after removing FlowID: " + str(data.columns))
    ...
    # # =============================================================================================
    data = data.drop(["FlowIATStd", "FwdIATStd", "CWRFlagCount"], axis=1).copy()
...
def prepare_cic_2017_data(PATH="", INPUT_FILE_NAME="", CSV_ONE_BOT=0):
    ...
    # if network_traffic:
    #     data= data.drop(['FlowID', 'Source IP', 'Source Port', 'Destination IP', 'Destination Port', 'Protocol', 'Timestamp'], axis=1).copy()
    #     if DEBUG:
    #         print('data_df after removing categorical features')
    #         print(data.shape)
